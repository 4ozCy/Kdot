...
--------------------------------------------------------------------------------------------------------
local Library = Update:Window("euphoria",Enum.KeyCode.RightControl);
--------------------------------------------------------------------------------------------------------
local Galaxy = Library:AddTab("Information","rbxassetid://17605483479")
local Settings = Library:AddTab("Settings Farming","rbxassetid://17605483479")
local Main = Library:AddTab("General","rbxassetid://17605483479")
local M = Library:AddTab("Item & Quest","rbxassetid://17605483479")
local Ss = Library:AddTab("Stats","rbxassetid://17605483479")
local RaceV4 = Library:AddTab("Race V4","rbxassetid://17605483479")
local EventGame = Library:AddTab("Game Event","rbxassetid://17605483479")
local P = Library:AddTab("Local Player","rbxassetid://17605483479")
local Status = Library:AddTab("Status Sever","rbxassetid://17605483479")
local Visual = Library:AddTab("Visual","rbxassetid://17605483479")
local R = Library:AddTab("Raid","rbxassetid://17605483479")
local T = Library:AddTab("Teleport","rbxassetid://17605483479")
local S = Library:AddTab("Shop","rbxassetid://17605483479")
local D = Library:AddTab("Fruit","rbxassetid://17605483479")
local Misc = Library:AddTab("Misc","rbxassetid://17605483479")
--------------------------------------------------------------------------------------------------------
Galaxy:AddSeperator("euphoria")
Galaxy:UserGalaxy()
local Creator = Galaxy:AddLabel('Hello '..game.Players.LocalPlayer.Name.."Kendrick Lamar on top")

spawn(function()
    while wait() do
        pcall(function()
            if game.Players.LocalPlayer.Name == "euphoria" then
