...
--------------------------------------------------------------------------------------------------------
local Library = Update:Window("Galaxy X Min Hub","BLOX FRUIT",Enum.KeyCode.RightControl);
--------------------------------------------------------------------------------------------------------
...
--------------------------------------------------------------------------------------------------------
Galaxy:AddSeperator("Galaxy X Min Hub")
Galaxy:UserGalaxy()
local Creator = Galaxy:AddLabel('Hello '..game.Players.LocalPlayer.Name.." To Galaxy X Min Hub Thanks Using")

spawn(function()
    while wait() do
        pcall(function()
            if game.Players.LocalPlayer.Name == "Galaxy X Min Hub" then
...
Galaxy:AddLabel("Galaxy X Min Hub")
